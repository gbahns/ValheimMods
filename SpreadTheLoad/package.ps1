...
# Output: SpreadTheLoad-<version>.zip in the project directory.
#
# Usage:
...
$zipPath    = Join-Path $projectDir "SpreadTheLoad-$Version.zip"
...
dotnet build "$projectDir\SpreadTheLoad.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net48\SpreadTheLoad.dll"    "BepInEx/plugins/SpreadTheLoad.dll"
