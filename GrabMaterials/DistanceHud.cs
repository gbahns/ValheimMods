...
namespace GrabMaterials
{
	...
	public static class DistanceHud
	{
		...
		private static bool Enabled => GrabMaterialsMod.GrabMaterialsMod.Instance?.ShowDistanceHud?.Value ?? true;
		private static bool ShowCoords => GrabMaterialsMod.GrabMaterialsMod.Instance?.ShowDistanceCoords?.Value ?? false;
		...
		private static float OffsetX => GrabMaterialsMod.GrabMaterialsMod.Instance?.DistanceHudOffsetX?.Value ?? 10f;
		private static float OffsetY => GrabMaterialsMod.GrabMaterialsMod.Instance?.DistanceHudOffsetY?.Value ?? 10f;
		...
		private static void EnsureCreated()
		{
			...
			_go.name = "GrabMaterials_DistanceHud";
