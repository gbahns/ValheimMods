...
# Output: DistanceFromWorldCenter-<version>.zip in the project directory.
#
# Usage:
...
$zipPath    = Join-Path $projectDir "DistanceFromWorldCenter-$Version.zip"

Write-Host "Building Release..."
dotnet build "$projectDir\DistanceFromWorldCenter.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net462\DistanceFromWorldCenter.dll"    "BepInEx/plugins/DistanceFromWorldCenter.dll"
