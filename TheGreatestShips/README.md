...
a gate on each side: look at it and Use, and it folds outboard into a ramp from the pen floor up
over the gunwale, so with the ship alongside a dock at rail height animals can walk off, or on.
