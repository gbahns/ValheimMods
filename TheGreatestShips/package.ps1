...
# Output: TheGreatestShips-<version>.zip in the project directory.
#
# Usage:
#   package.ps1 -Version "0.9.0"              # build + zip only
#   package.ps1 -Version "0.9.0" -Publish     # build + zip + upload to Thunderstore
...
$zipPath    = Join-Path $projectDir "TheGreatestShips-$Version.zip"
...
dotnet build "$projectDir\TheGreatestShips.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net48\TheGreatestShips.dll"    "BepInEx/plugins/TheGreatestShips.dll"
