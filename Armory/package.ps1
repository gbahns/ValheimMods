...
# Output: Armory-<version>.zip in the project directory.
#
# Usage:
...
$zipPath    = Join-Path $projectDir "Armory-$Version.zip"
...
dotnet build "$projectDir\Armory.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net48\Armory.dll"    "BepInEx/plugins/Armory.dll"
