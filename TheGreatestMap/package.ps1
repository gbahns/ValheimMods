...
# Output: TheGreatestMap-<version>.zip in the project directory.
#
# Usage:
...
$zipPath    = Join-Path $projectDir "TheGreatestMap-$Version.zip"
...
dotnet build "$projectDir\TheGreatestMap.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net48\TheGreatestMap.dll"    "BepInEx/plugins/TheGreatestMap.dll"
