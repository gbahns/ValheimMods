...
- Picking something that never grows back now erases its marker, for everyone. Carrot, turnip and onion seeds do not respawn, so their markers were wrong the moment you harvested them, and they are also no longer recorded once picked. Berries, mushrooms, thistle and the rest do respawn and keep their markers as before. `tgm_look` reports which is which for whatever you are pointing at, straight from the object in front of you.
