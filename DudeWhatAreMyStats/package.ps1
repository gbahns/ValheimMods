...
# Output: DudeWhatAreMyStats-<version>.zip in the project directory.
#
# Usage:
...
$zipPath    = Join-Path $projectDir "DudeWhatAreMyStats-$Version.zip"
...
dotnet build "$projectDir\DudeWhatAreMyStats.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net48\DudeWhatAreMyStats.dll"    "BepInEx/plugins/DudeWhatAreMyStats.dll"
