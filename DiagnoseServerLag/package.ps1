...
# Output: DiagnoseServerLag-<version>.zip in the project directory.
#
# Usage:
...
$zipPath    = Join-Path $projectDir "DiagnoseServerLag-$Version.zip"
...
dotnet build "$projectDir\DiagnoseServerLag.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net48\DiagnoseServerLag.dll"    "BepInEx/plugins/DiagnoseServerLag.dll"
