    ...
    internal static class UiKit
    {
        ...
        internal sealed class WheelScroller : MonoBehaviour, IScrollHandler
        {
            ...
            public void OnScroll(PointerEventData eventData)
            {
                ...
                if (range <= 0f) return;
                float rows = DslConfig.ListScrollRows != null ? DslConfig.ListScrollRows.Value : 4;
        ...
        /// <summary>
        /// One right-click menu shared by every row: a short list of labeled actions that pops up
