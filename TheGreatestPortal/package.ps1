...
# Output: TheGreatestPortal-<version>.zip in the project directory.
#
# Usage:
...
$zipPath    = Join-Path $projectDir "TheGreatestPortal-$Version.zip"
...
dotnet build "$projectDir\TheGreatestPortal.csproj" -c Release
...
Add-ZipEntry $zip "$projectDir\bin\Release\net48\TheGreatestPortal.dll"    "BepInEx/plugins/TheGreatestPortal.dll"
